...
STOPWORDS = stopwords.words('english') + stopwords.words('german') + stopwords.words('dutch') + oapen_stopwords.stopwords_dutch_extra + oapen_stopwords.stopwords_filter + oapen_stopwords.stopwords_publisher
...
def get_data(collection_limit = 1, item_limit = 10) -> List[OapenItem]:
    books_collections = OapenAPI.get_collections_from_community(OapenAPI.BOOKS_COMMUNITY_ID)
    books_items = []
